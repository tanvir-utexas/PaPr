...
parser.add_argument('--vit_arch', type=str, default='medium', 
                        choices=["medium"])
...
parser.add_argument('--input_size', default=256, type=int,
                    help='size of images.', choices=[256, 384])
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    model_name = f"vit_medium_patch16_gap_{args.input_size}"
    ...
    if args.z < 1.0:
        PaPr.create_class_token_free_ViT_model(model, proposal_model=args.prop_arch, z=args.z, input_size=args.input_size, proposal_weights=args.proposal_weights)
