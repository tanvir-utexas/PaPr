...
z=0.4
CONFIG=./configs/recognition/videomae_papr/vit-base-p16_videomae-k400-pre_16x4x1_kinetics-400.py
CHECKPOINT=./checkpoints/vit-base-p16_videomae-k400-pre_16x4x1_kinetics-400_20221013-860a3cd3.pth
WORK_DIR=./work_dirs/MAE_PaPr_Base/z_${z}
