...
from utils import batch_index_fill, batch_index_select, batch_index_fill_single
...
class PaPrSwinTransformerBlock(nn.Module):
    ...
    def forward(self, x, mask=None):
        ...
        if mask is None:
            ...
            with torch.no_grad():            
                ...
                num_keep_node = int(self.fraction * H * W)
                idx1 = idx[:, :num_keep_node]
                idx2 = idx[:, num_keep_node:]
...
class BasicLayer(nn.Module):
    ...
    def __init__(self, dim, input_resolution, depth, num_heads, window_size,
        ...
        for i in range(depth):
            modules.append(
                PaPrSwinTransformerBlock(dim=dim, input_resolution=input_resolution,
...
class PaPrSwinTransformer(nn.Module):
    r""" Swin Transformer
